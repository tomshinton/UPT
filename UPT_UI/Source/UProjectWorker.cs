...
namespace UPT_UI
{
    ...
    {
        public delegate void OnProjectInitialised(bool WasSuccessful);
        ...
        private static async Task<bool> AsyncFindBatchFiles(string InEngineDirectory)
        {
            return await Task.Run(async () =>
            {
                ...
                foreach (string foundExe in allExeFiles)
                {
                    ...
                    if (foundExe.Contains(EditorSubstring) || foundExe.Contains(UE5EditorSubstring))
                    {
        ...
        private static string EditorSubstring = "UE4Editor-Cmd";
        private static string UE5EditorSubstring = "UnrealEditor-Cmd";
